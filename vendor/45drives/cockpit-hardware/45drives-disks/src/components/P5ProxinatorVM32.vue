<template>
    <div id="p5-proxinatorvm32" class="self-stretch m-2 flex justify-center"></div>
</template>
...
const assets = {
    chassis: {
        path: "img/chassis/vm32-proxinator.png",
        image: null,
    },
    disks: {
        caddy: {
    ...
    setup() {
        ...
        const p5Script = function (p5) {
            ...
            p5.setup = (_) => {
                ...
                canvas.parent("p5-proxinatorvm32");
                p5.frameRate(24);

<template>
    <div id="p5-stornadof16" class="self-stretch m-2 flex justify-center"></div>
  </template>
  ...
  const assets = {
    chassis: {
      path: "img/chassis/f16-stornado-chassis.png",
      image: null,
    },
    disks: {
      caddy: {

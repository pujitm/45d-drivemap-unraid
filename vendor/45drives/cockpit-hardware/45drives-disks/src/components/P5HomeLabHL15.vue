<template>
    <div id="p5-hl15-homelab" class="self-stretch m-2 flex justify-center"></div>
  </template>
  ...
  const assets = {
    chassis: {
      path: "img/chassis/hl15-homelab.png",
      image: null,
    },
    fade: {
      path: "img/chassis/hl15-chassis-fade.png",
      image: null,
    },
    disks: {
      caddy: {

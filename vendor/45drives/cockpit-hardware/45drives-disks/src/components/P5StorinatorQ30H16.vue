<template>
  <div id="p5-q30-h16-storinator" class="self-stretch m-2 flex justify-center"></div>
</template>
...
const assets = {
  chassis: {
    path: "img/chassis/q30-h16-storinator.png",
    image: null,
  },
  fade: {
...
zfsAnimation(p5);
      ...
      p5.setup = (_) => {
        ...
        canvas.parent("p5-q30-h16-storinator");

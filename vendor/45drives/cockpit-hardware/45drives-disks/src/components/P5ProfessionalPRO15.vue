<template>
    <div id="p5-pro15-professional" class="self-stretch m-2 flex justify-center"></div>
  </template>
  ...
  const assets = {
    chassis: {
      path: "img/chassis/pro15-professional.png",
      image: null,
    },
    fade: {
      path: "img/chassis/pro15-chassis-fade.png",
      image: null,
    },
    disks: {
      caddy: {
    ...
    setup() {
      ...
      const p5Script = function (p5) {
        ...
        p5.setup = (_) => {
          ...
          canvas.parent("p5-pro15-professional");

<template>
    <div id="p5-pro4-professional" class="self-stretch m-2 flex justify-center"></div>
  </template>
  ...
  const assets = {
    chassis: {
      path: "img/chassis/pro4-professional.png",
      image: null,
    },
    // fade: {
  ...
  const diskLocations = [    // If chassis image is 96 dpi (144x165)
    ...
    setup() {
      ...
      const p5Script = function (p5) {
        ...
        p5.setup = (_) => {
          ...
          canvas.parent("p5-pro4-professional");

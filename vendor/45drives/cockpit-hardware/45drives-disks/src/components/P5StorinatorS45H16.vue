<template>
  <div id="p5-s45-h16-storinator" class="self-stretch m-2 flex justify-center"></div>
</template>
...
const assets = {
  chassis: {
    path: "img/chassis/s45-h16-storinator.png",
    image: null,
  },
  fade: {
  ...
  setup() {
    ...
    const p5Script = function (p5) {
      ...
      p5.setup = (_) => {
        ...
        canvas.parent("p5-s45-h16-storinator");
